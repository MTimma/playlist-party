...
// // 9. Search tracks endpoint (using client credentials)
// app.get('/api/spotify/search', searchLimiter, (async (req, res) => {
//   try {
//     const { q, type = 'track', limit = '10' } = req.query;
...
// 10. Get currently playing track from Spotify (for a specific lobby) - LEGACY ENDPOINT
// (Removed duplicate legacy /api/spotify/currently-playing/:lobbyId endpoint)

// 11. Validate guess endpoint
app.post('/api/game/validate-guess', (async (req, res) => {
  console.log('=== Guess Validation Request ===');
  console.log('Request body:', req.body);
